...
}catch (e5014){if(cljs.core.instance_QMARK_.call(null,Error,e5014))
{var e = e5014;
return null;
} else
{if("\uFDD0'else")
...
var path = (((function (){var G__5017 = f;
if(G__5017)
{if(cljs.core.truth_((function (){var or__3943__auto__ = null;
if(cljs.core.truth_(or__3943__auto__))
{return or__3943__auto__;
} else
{return G__5017.cljs$io$IFile$;
}
})()))
{return true;
} else
{if((!G__5017.cljs$lang$protocol_mask$partition$))
{return cljs.core.type_satisfies_.call(null,cljs.io.IFile,G__5017);
} else
{return false;
}
}
...
{var req = (function (){var G__5018 = (new XMLHttpRequest());
G__5018.open("GET",path,false);
return G__5018;
})();
req.send();
...
var path = (((function (){var G__5020 = f;
if(G__5020)
{if(cljs.core.truth_((function (){var or__3943__auto__ = null;
if(cljs.core.truth_(or__3943__auto__))
{return or__3943__auto__;
} else
{return G__5020.cljs$io$IFile$;
}
})()))
{return true;
} else
{if((!G__5020.cljs$lang$protocol_mask$partition$))
{return cljs.core.type_satisfies_.call(null,cljs.io.IFile,G__5020);
} else
{return false;
}
}
...
if(left)
{{
var G__5021 = [cljs.core.str(cur),cljs.core.str(cljs.core.first.call(null,left)),cljs.core.str("/")].join('');
var G__5022 = cljs.core.next.call(null,left);
cur = G__5021;
left = G__5022;
continue;
}
...
var path__$1 = (((function (){var G__5027 = path;
if(G__5027)
{if(cljs.core.truth_((function (){var or__3943__auto__ = null;
if(cljs.core.truth_(or__3943__auto__))
{return or__3943__auto__;
} else
{return G__5027.cljs$io$IFile$;
}
})()))
{return true;
} else
{if((!G__5027.cljs$lang$protocol_mask$partition$))
{return cljs.core.type_satisfies_.call(null,cljs.io.IFile,G__5027);
} else
{return false;
}
}
...
var parent__$1 = (((function (){var G__5028 = parent;
if(G__5028)
{if(cljs.core.truth_((function (){var or__3943__auto__ = null;
if(cljs.core.truth_(or__3943__auto__))
{return or__3943__auto__;
} else
{return G__5028.cljs$io$IFile$;
}
})()))
{return true;
} else
{if((!G__5028.cljs$lang$protocol_mask$partition$))
{return cljs.core.type_satisfies_.call(null,cljs.io.IFile,G__5028);
} else
{return false;
}
}
...
var path__$1 = (((function (){var G__5029 = path;
if(G__5029)
{if(cljs.core.truth_((function (){var or__3943__auto__ = null;
if(cljs.core.truth_(or__3943__auto__))
{return or__3943__auto__;
} else
{return G__5029.cljs$io$IFile$;
}
})()))
{return true;
} else
{if((!G__5029.cljs$lang$protocol_mask$partition$))
{return cljs.core.type_satisfies_.call(null,cljs.io.IFile,G__5029);
} else
{return false;
}
}
...
return (new cljs.io.File([cljs.core.str(d),cljs.core.str(cljs.io.path_separator),cljs.core.str(p1__5023_SHARP_)].join('')));
}),d.listFiles());
}),dir);
});
if(cljs.core.truth_(cljs.io.is_node_QMARK_))
{var prog_5031 = cljs.io.path_dirname.call(null,(process.argv[1]));
cljs.io._STAR_clojurescript_home_STAR_ = cljs.io.path_resolve.call(null,[cljs.core.str(prog_5031),cljs.core.str("/..")].join(''));
} else
{}
/**
...
{var finder = (function (p1__5030_SHARP_){
var p = [cljs.core.str(cljs.io._STAR_clojurescript_home_STAR_),cljs.core.str("/"),cljs.core.str(p1__5030_SHARP_),cljs.core.str("/"),cljs.core.str(file)].join('');
...
var G__5032__delegate = function (m){
return cljs.core.first.call(null,m);
};
var G__5032 = function (var_args){
var m = null;
if (goog.isDef(var_args)) {
  m = cljs.core.array_seq(Array.prototype.slice.call(arguments, 0),0);
} 
return G__5032__delegate.call(this, m);
};
G__5032.cljs$lang$maxFixedArity = 0;
G__5032.cljs$lang$applyTo = (function (arglist__5033){
var m = cljs.core.seq(arglist__5033);;
return G__5032__delegate(m);
});
